...
from FlightManager import db, app
...
if __name__ == '__main__':
    with app.app_context():
        ...
        sb1 = AirPort(name='Sân bay Nội Bài', location='Hà Nội',
                      image='https://res.cloudinary.com/dp87nci6w/image/upload/v1678081306/Flight/HaNoi_wkzzg5_yrpces.jpg')
        sb2 = AirPort(name='Sân bay Tân Sơn Nhất', location='Hồ Chí Minh',
                      image='https://res.cloudinary.com/dp87nci6w/image/upload/v1678081377/Flight/HCM_jpkw5e_cy0tt1.jpg')
        sb3 = AirPort(name='Sân bay Phù Cát', location='Bình Định',
                      image='https://res.cloudinary.com/dp87nci6w/image/upload/v1678081445/Flight/BinhDinh_c6yrif_rpbiiu.jpg')
        sb4 = AirPort(name='Sân bay Narita', location='Nhật Bản',
                      image='https://res.cloudinary.com/dp87nci6w/image/upload/v1678081446/Flight/NhatBan_fzo3qw_kprcpz.jpg')
        sb5 = AirPort(name='Sân bay Bangkok', location='Thái Lan',
                      image='https://res.cloudinary.com/dp87nci6w/image/upload/v1678081445/Flight/ThaiLan_k533hb_ubywcq.jpg')
